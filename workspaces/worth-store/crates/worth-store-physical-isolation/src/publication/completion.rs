use super::{
    CopyOnWritePublicationBinding, CrashStableFreeReusePosture, OldReachabilityPreservation,
...
/// Local validation/planning result, never evidence of a published Store root.
#[derive(Debug, Clone)]
pub struct PhysicalPublicationPlanCompletion {
...
impl PhysicalPublicationCounterSnapshot {
    ...
    pub(crate) const fn for_completed_plan() -> Self {
        Self {
            intent_validations: 1,
            old_reachability_checks: 1,
            epoch_checks: 1,
...
impl PhysicalPublicationPlanCompletion {
    pub(crate) fn from_completed_plan(
        ...
        Self {
            ...
            counters: PhysicalPublicationCounterSnapshot::for_completed_plan(),
        }
    }
}
