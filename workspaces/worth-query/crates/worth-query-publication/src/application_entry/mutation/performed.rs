        ...
        >,
{
    ...
    result: MutationResult<Schema, Intent>,
    required_output:
        crate::application_entry::WorthQueryApplicationProgramOutputHandle<'application, Schema, Program>,
}
        ...
        >,
{
                ...
                > + Clone,
    {
        ...
        let demand = Program::Connections::demand_from_source(&self.request.intent)
