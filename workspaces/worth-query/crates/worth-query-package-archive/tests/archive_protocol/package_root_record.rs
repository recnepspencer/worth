...
const VERSION_THREE_PACKAGE_ROOT_FRAMES_HEX: &str = "0003000100000000000000190000000d61636d652e776f726b666c6f770000000300000007|00030002000000010000000e0000000a67726170682e72656164|00030003000000020000001400000010776f726b666c6f772e72756e74696d65|00030004000000030000000b0000000764757261626c65|00030005000000040000002600010000000862616c616e636564000000146465626974732d657175616c2d63726564697473|00030005000000050000002800020000000d6163636f756e742d62792d69640000001165786163742d656e746974792d72656164|00030005000000060000002e00030000000e7061796d656e742d6e6f746963650000001665787465726e616c2d6566666563742d66616d696c79|0003000a0000000700000009000000056175646974";
...
#[test]
fn version_three_package_root_frames_match_and_decode_the_frozen_vectors() {
    let source = root_package();
    let exported = source.export_typed_records().unwrap();
    let encoded = exported
        ...
        .collect::<Vec<_>>()
        .join("|");
    assert_eq!(encoded, VERSION_THREE_PACKAGE_ROOT_FRAMES_HEX);

    let independent_frames = VERSION_THREE_PACKAGE_ROOT_FRAMES_HEX
        .split('|')
        .map(decode_hex)
        .collect::<Vec<_>>();
