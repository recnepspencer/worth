...
const VERSION_THREE_CONDITIONAL_BINDING_HEX: &str = "";
...
fn conditional_application_operation_frame_is_deterministic_and_exact() {
    ...
    assert_eq!(encode_hex(&first), VERSION_THREE_CONDITIONAL_BINDING_HEX);
    assert_eq!(u16::from_be_bytes(first[2..4].try_into().unwrap()), 9);

    let mut decoder = WorthQueryPackageArchiveRecordDecoder::new(limits);
    let decoded = decoder
        .decode_frame(&decode_hex(VERSION_THREE_CONDITIONAL_BINDING_HEX))
        .unwrap();
