...
use super::courtroom_lifecycle::assert_conditional_resources_empty;
...
pub(super) fn publishes_delivers_executes_and_cleans_up() {
    ...
    let published = world.application.admit_current_product_branch().unwrap();
