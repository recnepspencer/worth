...
mod contract;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/courtroom.rs"]
mod courtroom;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/courtroom_lifecycle.rs"]
mod courtroom_lifecycle;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/courtroom_settlement.rs"]
...
#[path = "../../worth-query-host/tests/temporal_conditional_operation/product_query_support.rs"]
mod product_query_support;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/public_live_route.rs"]
mod public_live_route;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/public_product_journey.rs"]
mod public_product_journey;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/schema.rs"]
mod schema;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/selected_product_lifecycle.rs"]
mod selected_product_lifecycle;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/selected_product_reads.rs"]
mod selected_product_reads;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/shared_root_progress.rs"]
mod shared_root_progress;
#[path = "../../worth-query-host/tests/temporal_conditional_operation/world.rs"]
mod world;

pub(crate) use world as host_world;

#[path = "runtime_world_branching/cost.rs"]
mod cost;
#[path = "runtime_world_branching/cumulative.rs"]
mod cumulative;
...
#[path = "runtime_world_branching/model.rs"]
mod model;
#[path = "runtime_world_branching/query_probe.rs"]
mod query_probe;
