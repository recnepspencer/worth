...
pub(super) const PROFILE: UiNativeQualifiedProfile = UiNativeQualifiedProfile {
    identity: UiNativePlatformProfileIdentity::WORTH_UI_LINUX_X11_VULKAN_V1,
    manifest: include_str!("../../profiles/worth-ui-linux-x11-vulkan-v1.toml"),
    windowing_system: UiNativeWindowingSystem::X11,
    device_label: "worth-ui-linux-x11-vulkan-v1-device",
    recovered_device_label: "worth-ui-linux-x11-vulkan-v1-recovered-device",
