...
pub(super) const PROFILE: UiNativeQualifiedProfile = UiNativeQualifiedProfile {
    identity: UiNativePlatformProfileIdentity::WORTH_UI_LINUX_WAYLAND_VULKAN_V1,
    manifest: include_str!("../../profiles/worth-ui-linux-wayland-vulkan-v1.toml"),
    windowing_system: UiNativeWindowingSystem::Wayland,
    device_label: "worth-ui-linux-wayland-vulkan-v1-device",
    recovered_device_label: "worth-ui-linux-wayland-vulkan-v1-recovered-device",
    ...
    appearance: UiNativeAppearanceProfile {
        identity: "worth-ui-linux-wayland-vulkan-v1",
        version: 1,
