...
pub(super) const RECORD: QualifiedProfileRecord = QualifiedProfileRecord {
    manifest_sha256: "9985fa0a61a793421de216bb352d5c9da2e9269e8d2664a01cdfcbb15564745b",
...
const STRING_FIELDS: &[(&str, &str)] = &[
    ...
    ("wheel_notch_observation", "winsafe-0.0.28-advapi:RegGetValue;HKCU\\Control Panel\\Desktop\\WheelScrollLines;REG_SZ;page-scroll-stated-not-truncated"),
