...
/// The closed record of `profiles/worth-ui-linux-wayland-vulkan-v1.toml`.
pub(super) const RECORD: QualifiedProfileRecord = QualifiedProfileRecord {
    manifest_sha256: "81d334d3e62c3c163a0726ff1c7a9c01d69c7ba00fd9ed4b8fac532c29837be0",
...
const STRING_FIELDS: &[(&str, &str)] = &[
    ...
    ("client_area_observation", "unobserved"),
    ...
    ("client_input_observation", "unobserved"),
    ("client_visibility_transition_observation", "unobserved"),
];
