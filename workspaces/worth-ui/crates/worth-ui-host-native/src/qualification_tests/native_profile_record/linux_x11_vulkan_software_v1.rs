...
/// The closed record of `profiles/worth-ui-linux-x11-vulkan-software-v1.toml`.
pub(super) const RECORD: QualifiedProfileRecord = QualifiedProfileRecord {
    manifest_sha256: "2a929eedad09472123444d5b612bac867a7ba12491eb275e79631ae7f31e2add",
...
const STRING_FIELDS: &[(&str, &str)] = &[
    ...
    ("adapter_order", "discrete;integrated;virtual;cpu;vendor-id;device-id;name;driver-info"),
    ("cpu_adapter", "allow"),
    ("other_adapter", "deny"),
