...
- Domain noun: `host-contract`
- Crate root: `workspaces/worth-ui/crates/worth-ui-host-contract`
...
- Facade exports: `none`
- Owned internal modules: `inspection, mounted_frame, mounted_projection, mounted_target_coherence, observation_report, operational_adapter, qualified_text, runtime, visual_snapshot`
