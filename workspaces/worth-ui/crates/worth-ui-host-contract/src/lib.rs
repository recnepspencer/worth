...
pub use mounted_projection::{
    ...
    UiMountedAllocationProjection, UiMountedAppearanceColor, UiMountedAppearanceOpacity,
    ...
    UiMountedBackdropScope, UiMountedCanonicalBox, UiMountedCanonicalBoxInput,
    UiMountedClientCoordinateBasis, UiMountedClientPhysicalRect, UiMountedClipProjection,
    UiMountedClipReference, UiMountedClipRow, UiMountedClipTable,
