...
pub use mounted_projection::{
    ...
    UiMountedDiagnosticReference, UiMountedDrawableReference, UiMountedGeometryDenial,
...
pub use observation_report::{
    ...
    UiHostScrollLineCountBasis, UiHostSurfaceCoordinateSpace, UiHostSurfaceCoordinateUnit,
    ...
    UI_HOST_OBSERVATION_DRAIN_REPORT_LIMIT, UI_HOST_SCROLL_DEFAULT_LINES_PER_NOTCH,
