...
pub use observation_report::{
    ...
    UiHostScrollDeltaSource, UiHostScrollDeltaTargetAffinity, UiHostSurfaceCoordinateSpace,
    UiHostSurfaceCoordinateUnit, UiHostSurfacePosition, UiHostSurfacePositionBasis,
    UiHostUnicodeScalarRange, UiHostUtf8ByteRange, UI_HOST_OBSERVATION_ACTIVE_SESSION_LIMIT,
