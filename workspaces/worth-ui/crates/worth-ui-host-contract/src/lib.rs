...
pub use mounted_projection::{
    ...
    UiHostAppearanceProfilePosture, UiHostPrimaryPointerKind, UiMountedAccessibilityProjection,
    UiMountedAllocationBasis, UiMountedAllocationProjection, UiMountedAppearanceColor,
    UiMountedAppearanceFrame, UiMountedAppearanceFrameDenial, UiMountedAppearanceMechanic,
    UiMountedAppearanceMechanicChange, UiMountedAppearanceMechanicIdentity,
    UiMountedAppearanceOpacity, UiMountedAppearancePredecessorManifest, UiMountedAppearanceWork,
