...
fn component(name: &str, x: u16) -> crate::capability::ComponentDescriptor {
    ...
    let token = ThemeTokenId::new(support::APPEARANCE_BASE_TOKEN).unwrap();
    crate::runtime::tests::appearance_component_session_test_support::appearance_component_with_allocation(
...
pub(super) fn source() -> WorthUiRustAuthoredArtifactInput {
